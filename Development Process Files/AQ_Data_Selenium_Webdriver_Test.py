...
for i in sites:
    ...
    URL = ('https://airquality.ie/readings?station=' + i + '&dateFrom=01+Dec+2021&dateTo=02+Dec+2021')
    driver.get(URL)
    print("Opened " + URL)
    ...
    #Expand highcharts hamburger button
        ...
        print("Collected data from " + str(progress) + " of " + str(sites_count) + " sites. " + str(round(percent, 1)) + "% Complete")

print('After loop - Print df')
df.to_csv('aq_concatenated_df_test.csv')
print(df)
