...
df_location = df_read['location'].unique()
df_location = df_location[0:15]

window = Tk()
window.title("Select a location:")

variable = StringVar(window)
variable.set(df_location[0])  # default value
...
df_month = pd.read_csv("top_sites_monthly_max_mean.csv")
